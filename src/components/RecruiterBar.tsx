...
export const RecruiterBar: React.FC<RecruiterBarProps> = ({ lang }) => {
  ...
  return (
    <aside aria-label="Recruiter Quick Actions" className="fixed bottom-4 inset-x-0 z-40 px-3 pointer-events-none">
        ...
        <div className="bg-[#0B101B]/95 border border-sky-500/30 rounded-2xl p-2.5 sm:p-3 backdrop-blur-2xl shadow-2xl shadow-black/80 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              <span>{copied ? t.recruiterBar.copied : t.recruiterBar.copyEmail}</span>
            </button>
            ...
            >
              ...
              <span className="hidden sm:inline">{t.recruiterBar.whatsapp}</span>
            </a>
