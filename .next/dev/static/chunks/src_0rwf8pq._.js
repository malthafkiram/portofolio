...
function HomePage() {
    ...
    if ($[0] !== "182b3da9793d59ba4aef5c7d965c6dca64a924a9f99f91bcf5c9419f25faec94") {
        for(let $i = 0; $i < 53; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "182b3da9793d59ba4aef5c7d965c6dca64a924a9f99f91bcf5c9419f25faec94";
    }
    const { lang } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LanguageProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    ...
    let t19;
    if ($[43] !== t10 || $[44] !== t11 || $[45] !== t12 || $[46] !== t13 || $[47] !== t14 || $[48] !== t15 || $[49] !== t16 || $[50] !== t18 || $[51] !== t3) {
...
_s(HomePage, "7M03WIu4M2YVkG2R/FrZLJCAF+M=", false, function() {
    return [
...
const ProjectCard = (t0)=>{
    ...
    if ($[0] !== "0263419bc328e1d6dc51ffd080581372c77cb78bc26a06b2e1dc5c2345d4fa25") {
        for(let $i = 0; $i < 77; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0263419bc328e1d6dc51ffd080581372c77cb78bc26a06b2e1dc5c2345d4fa25";
    }
    ...
    const shots = t1;
    const [shotIndex, setShotIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const mainScreenshot = shots.length > 0 ? shots[shotIndex % shots.length].src : null;
    let t2;
    if ($[3] !== shots.length) {
        t2 = (dir)=>(e)=>{
                e.preventDefault();
                ...
                setShotIndex((i)=>(i + dir + shots.length) % shots.length);
            };
        $[3] = shots.length;
        $[4] = t2;
    } else {
    ...
    const stepShot = t2;
    const t3 = `group relative rounded-3xl p-5 sm:p-7 transition-all duration-500 flex flex-col justify-between ${project.isMasterpiece ? "bg-gradient-to-b from-[#0F172A]/90 to-[#0A0E17]/90 border-2 border-sky-500/50 shadow-2xl shadow-sky-500/15 hover:border-sky-400" : "bg-[#0B101B]/80 border border-white/10 hover:border-sky-500/40 shadow-xl hover:shadow-2xl hover:shadow-sky-500/10"}`;
    const t4 = `px-3 py-1 text-[11px] font-mono font-bold uppercase rounded-full border ${project.isMasterpiece ? "bg-sky-500/20 text-sky-300 border-sky-400/50 shadow-md shadow-sky-500/20" : "bg-white/5 text-gray-300 border-white/10"}`;
    const t5 = project.badge[lang];
    let t6;
    if ($[5] !== t4 || $[6] !== t5) {
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: t4,
    ...
    let t12;
    if ($[18] !== mainScreenshot || $[19] !== onSelectProject || $[20] !== project || $[21] !== shotIndex || $[22] !== shots || $[23] !== stepShot || $[24] !== t.viewDeepDive) {
        t12 = mainScreenshot ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t13;
    if ($[26] !== onSelectProject || $[27] !== project) {
        t13 = ()=>onSelectProject(project);
        $[26] = onSelectProject;
        $[27] = project;
        $[28] = t13;
    } else {
    ...
    const t15 = project.tagline[lang];
    let t16;
    if ($[32] !== t15) {
    ...
    let t20;
    if ($[41] !== t11 || $[42] !== t12 || $[43] !== t17 || $[44] !== t19) {
        t20 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "space-y-5",
            children: [
                t11,
    ...
    let t21;
    if ($[46] !== onSelectProject || $[47] !== project) {
        t21 = ()=>onSelectProject(project);
        $[46] = onSelectProject;
        $[47] = project;
        $[48] = t21;
    } else {
    ...
    let t25;
    if ($[55] !== lang || $[56] !== project.live || $[57] !== project.liveLabel || $[58] !== t.liveDemo) {
        t25 = project.live && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
            href: project.live,
            target: "_blank",
            rel: "noopener noreferrer",
    ...
    let t26;
    if ($[60] !== project.github || $[61] !== t.github) {
        t26 = project.github && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
            href: project.github,
            target: "_blank",
            rel: "noopener noreferrer",
    ...
    let t27;
    if ($[63] !== project.githubBe || $[64] !== t.githubBe) {
        t27 = project.githubBe && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
...
_s(ProjectCard, "YWBG8Sn98aa1kBVcTfK2PSGd0c8=");
_c = ProjectCard;
...
//# sourceMappingURL=src_0rwf8pq._.js.map